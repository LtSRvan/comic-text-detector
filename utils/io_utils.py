...
NP_FLOAT_TYPES = (np.floating, np.float16, np.float32, np.float64)
NP_INT_TYPES = (np.integer, np.int8, np.int16, np.int32, np.int64, np.uint8, np.uint16, np.uint32, np.uint64)
